    ...
    <>
      ...
      <section className="section home-services" ref={servicesRef} id="services">
        <div className="container">
          ...
          <div className="services-grid">
            {services.map((s, i) => (
              <ServiceCard key={s.slug} title={s.title} img={s.img} desc={s.desc} slug={s.slug} delay={i * 50} />
            ))}
          </div>
      ...
      <section className="section home-about" ref={aboutRef}>
        <div className="container home-about__inner">
          <div className="home-about__image fade-in">
            <img src="/about-impact.jpg" alt="Community impact" />
          </div>
          <div className="home-about__content fade-in">
      ...
      <section className="section home-why" ref={whyRef}>
        <div className="container">
          ...
          <div className="why-grid">
            {whyUs.map((item, i) => (
              <div className="why-card fade-in" key={item.title} style={{ transitionDelay: `${i * 80}ms` }}>
      ...
      <section className="section home-how" ref={howRef}>
        <div className="container">
          ...
          <div className="steps-grid">
            {steps.map((step, i) => (
              <div className="step-card fade-in" key={step.num} style={{ transitionDelay: `${i * 120}ms` }}>
        ...
        <div className="container">
          ...
          <div className="testimonials-grid">
            {testimonials.map((t, i) => (
              <div className="testimonial-card fade-in" key={t.name} style={{ transitionDelay: `${i * 100}ms` }}>
