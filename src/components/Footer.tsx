      ...
      <div className="container">
        <div className="footer__grid">
          <div className="footer__col">
            <img src="/logo.png" alt="Breezyee Moves" className="footer__logo" />
            <p className="footer__desc">
              London's trusted social enterprise for removals and logistics.
              Making moves stress-free while giving back to the community.
            </p>
